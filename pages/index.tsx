...
Total Outreach Contacts: ${studentsAnswered + voicemails + studentsAttempted + emailsSent}
...
Documented everything in the shared spreadsheet.`;
  ...
  const CounterButton = ({ 
    ...
    <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-100 hover:shadow-xl transition-all duration-300">
      <h3 className="text-xs sm:text-sm font-semibold text-gray-500 mb-3 sm:mb-4 uppercase tracking-wide text-center sm:text-left">{label}</h3>
      <div className="flex items-center justify-between">
        <button
          onClick={onDecrement}
          className="w-12 h-12 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-br from-red-50 to-red-100 text-red-500 hover:from-red-100 hover:to-red-200 hover:text-red-600 transition-all duration-200 flex items-center justify-center font-bold text-lg shadow-sm hover:shadow-md touch-manipulation"
        >
          −
        </button>
        <span className="text-2xl sm:text-3xl font-bold text-gray-800 mx-4 sm:mx-6">{value}</span>
        <button
          onClick={onIncrement}
          className="w-12 h-12 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 text-blue-500 hover:from-blue-100 hover:to-blue-200 hover:text-blue-600 transition-all duration-200 flex items-center justify-center font-bold text-lg shadow-sm hover:shadow-md touch-manipulation"
        >
          +
        </button>
      </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-6 md:py-12">
        <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8 md:mb-12">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-3 md:mb-4">Student Outreach Tracker</h1>
            <p className="text-gray-600 text-sm sm:text-base lg:text-lg px-4">Monitor and track your student engagement activities</p>
          </div>

                    {/* Section 1: Appointments */}
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 mb-6 md:mb-10 border border-gray-100">
            <div className="flex items-center mb-6 md:mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Appointments</h2>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
             ...
             <div className="border-t border-gray-200 pt-6 md:pt-8">
               <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 md:mb-6 gap-3 sm:gap-0">
                 <h3 className="text-lg sm:text-xl font-bold text-gray-800">Students who Canceled/Changed Appointments</h3>
                 <button
                   onClick={addStudent}
                 ...
                 <p className="text-gray-500 text-center py-6 md:py-8 text-base md:text-lg">No students added yet</p>
               ) : (
                 <div className="space-y-3 md:space-y-4">
                   {canceledStudents.map((student) => (
                     <div key={student.id} className="bg-gray-50 rounded-2xl p-4 md:p-6 border border-gray-200">
                       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                         <div className="sm:col-span-2 lg:col-span-1">
                           <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Name</label>
                           <input
                             type="text"
                             value={student.name}
                             onChange={(e) => updateStudent(student.id, 'name', e.target.value)}
                             className="w-full px-3 md:px-4 py-2 md:py-3 border border-gray-300 rounded-xl md:rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-sm md:text-base"
                             placeholder="Student name"
                           />
                         </div>
                         <div>
                           <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Student ID</label>
                           <input
                             type="text"
                         ...
                         <div>
                           <label className="block text-xs sm:text-sm font-semibold text-gray-700 mb-1 md:mb-2">Advisor Assigned</label>
                           <input
                             type="text"
                         ...
                         <div className="flex items-end sm:col-span-2 lg:col-span-1">
                           <button
                             ...
                             className="w-full bg-gradient-to-r from-red-100 to-red-200 text-red-600 px-3 md:px-4 py-2 md:py-3 rounded-xl md:rounded-2xl hover:from-red-200 hover:to-red-300 transition-all duration-200 font-semibold text-sm md:text-base"
                           >
                             Remove
                           </button>
                         </div>
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 mb-6 md:mb-10 border border-gray-100">
            <div className="flex items-center mb-6 md:mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Call Campaign</h2>
            </div>
          ...
          <div className="bg-white rounded-2xl md:rounded-3xl shadow-xl p-4 sm:p-6 md:p-8 border border-gray-100">
            <div className="flex items-center mb-6 md:mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Summary Generator</h2>
            </div>
            
            <div className="text-center mb-6 md:mb-8">
              <button
                onClick={handleGenerateSummary}
                className="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 sm:px-8 md:px-10 py-3 md:py-4 rounded-2xl hover:from-purple-700 hover:to-purple-800 transition-all duration-200 font-semibold text-base md:text-lg shadow-lg hover:shadow-xl w-full sm:w-auto"
              >
                Generate Summary
              </button>
            </div>
            ...
            {summary && (
              <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4 md:p-8 border border-gray-200">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 md:mb-4 gap-3 sm:gap-0">
                  <h3 className="text-lg sm:text-xl font-bold text-gray-800">Email Summary</h3>
                  <button
                ...
                <div className="bg-white rounded-xl p-3 sm:p-4 md:p-6 border border-gray-200">
                  <pre className="whitespace-pre-wrap text-gray-700 text-xs sm:text-sm leading-relaxed font-mono overflow-x-auto">
                    {summary}
                  </pre>
                </div>
              </div>
          ...
          <div className="mt-8 md:mt-12 text-center">
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 border border-gray-200">
              <div className="flex items-center justify-center mb-3">
                ...
                <h3 className="text-base sm:text-lg font-bold text-gray-800">Privacy Protected</h3>
              </div>
